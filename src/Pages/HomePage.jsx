...
export function MainPage({data}) {
  ...
  return <Render config={config} data={data || initialData} />;
}
...
export function HomePage(){
  ...
  return (
    <div>
      <div style={{background:'lightgrey',padding:'2%',display:'flex',alignItems:'center',justifyContent:'end'}}>
        <div >Are you Admin? <span><button onClick={() => navigate('/editor')}>Edit Page</button></span></div>
      </div>
      <MainPage data={data}/>
    </div>
  )
